...
import com.yhms.xpopup.XPopup;
import com.yhms.xpopup.animator.EmptyAnimator;
import com.yhms.xpopup.animator.PopupAnimator;
import com.yhms.xpopup.animator.ScaleAlphaAnimator;
import com.yhms.xpopup.animator.ScrollScaleAnimator;
import com.yhms.xpopup.animator.ShadowBgAnimator;
import com.yhms.xpopup.animator.TranslateAlphaAnimator;
import com.yhms.xpopup.animator.TranslateAnimator;
import com.yhms.xpopup.enums.PopupStatus;
import com.yhms.xpopup.impl.FullScreenPopupView;
import com.yhms.xpopup.util.KeyboardUtils;
import com.yhms.xpopup.util.XPopupUtils;

import java.util.ArrayList;
import java.util.Stack;

import static com.yhms.xpopup.enums.PopupAnimation.NoAnimation;
    ...
    public void init() {
        ...
        if (!isCreated) {
            ...
            if (popupInfo.xPopupCallback != null) {
                popupInfo.xPopupCallback.onCreated();
            }
        }
